        ...
        <div className="chat-window">
          <div className="message ai">
            ...
            <div className="message-content">
              <div className="message-text">
                Start this conversation by taking your medicine photo.
              </div>
          ...
          <div className="message user">
            ...
            <div className="message-content">
              ...
              <div className="message-text">
                I've uploaded an image of a medicine for identification.
              </div>
              <div className="message-footer">
                <div className="message-time">19:46</div>
              </div>
          ...
          <div className="message ai">
            ...
            <div className="message-content">
              <div className="message-text">
                Error: API key not configured. Please upload a clear photo of medicine packaging, pills, or related medical items for proper identification.
              </div>
              <div className="message-footer">
                <div className="message-time">19:46</div>
              </div>
      ...
      {showCamera && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'black', zIndex: 1000 }}>
          ...
          <p style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', color: 'white', textAlign: 'center', background: 'rgba(0,0,0,0.7)', padding: '10px', borderRadius: '8px' }}>
            Camera Test - No transforms, testing default behavior
          </p>
        </div>
      )}
    </div>
